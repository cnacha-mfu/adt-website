              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {items.map(item => {
                  ...
                  return (
                    <article
                      key={item.id}
                      className="glass-card rounded-2xl overflow-hidden gradient-border group hover:-translate-y-1 transition-all duration-300 hover:shadow-card-hover flex flex-col cursor-pointer"
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <span className="flex items-center gap-1.5 text-teal text-sm font-medium mt-auto">
